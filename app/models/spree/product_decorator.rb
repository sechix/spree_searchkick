Spree::Product.class_eval do
  ...
  searchkick index_name: "#{Rails.application.class.parent_name.parameterize.underscore}_spree_products_#{Rails.env}", word_start: [:name, :brand, :name_and_brand, :description] unless respond_to?(:searchkick_index)
